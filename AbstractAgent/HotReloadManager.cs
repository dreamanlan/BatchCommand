...
namespace AgentPlugin.Abstractions
{
    ...
    public class HotReloadManager
    {
        ...
        private void WatchDirectory(string dirName, string relativePath, string fileType)
        {
            try {
                ...
                if (!Directory.Exists(fullDir)) {
                    Console.WriteLine($"[HotReload] Directory not found: {fullDir}");
                    return;
                }
                ...
                Console.WriteLine($"[HotReload] Watching directory: {fileType} at {fullDir}");
            }
            catch (Exception ex) {
                Console.WriteLine($"[HotReload] Failed to watch directory {dirName}: {ex.Message}");
            }
        }
