...
namespace AgentCore.Core
{
    ...
    public class AgentCore
    {
        ...
        // Close all pages, then reopen them. No dll is touched - this is the path used when the
        ...
        public void TriggerReopenBrowser()
        {
            _logger.Info("Triggering browser reopen...");
            ...
            try {
                ...
                _logger.Info("Reopen command sent to inject.js");
            }
            catch (Exception ex) {
                _logger.Error($"Error triggering browser reopen: {ex.Message}");
            }
        }
