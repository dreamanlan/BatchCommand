...
namespace CefDotnetApp.AgentCore.ScriptApi
{
    ...
    public class FrameworkApiAlias
    {
        public static void RegisterApis()
        {
            ...
            AgentFrameworkService.Instance.DslEngine!.Register("str_replace", "str_replace(str, substr, replace[, exactMatch])", false, new ExpressionFactoryHelper<StringReplaceExp>());
            AgentFrameworkService.Instance.DslEngine!.Register("replace_str", "replace_str(str, substr, replace[, exactMatch])", false, new ExpressionFactoryHelper<StringReplaceExp>());
