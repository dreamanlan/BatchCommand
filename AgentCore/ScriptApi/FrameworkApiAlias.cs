...
namespace CefDotnetApp.AgentCore.ScriptApi
{
    ...
    public class FrameworkApiAlias
    {
        public static void RegisterApis()
        {
            ...
            AgentFrameworkService.Instance.DslEngine!.Register("ifexpr", "ifexpr(expr,a,b)", false, new ExpressionFactoryHelper<CondExp>());
            ...
            AgentFrameworkService.Instance.DslEngine!.Register("split_str", "split_str(str, sep) or split_str(str,sep_list)", false, new ExpressionFactoryHelper<StringSplitExp>());
            ...
            AgentFrameworkService.Instance.DslEngine!.Register("str_trim", "str_trim(str)", false, new ExpressionFactoryHelper<StringTrimExp>());
            AgentFrameworkService.Instance.DslEngine!.Register("trim_str", "trim_str(str)", false, new ExpressionFactoryHelper<StringTrimExp>());
            ...
            AgentFrameworkService.Instance.DslEngine!.Register("str_trim_start", "str_trim_start(str)", false, new ExpressionFactoryHelper<StringTrimStartExp>());
            AgentFrameworkService.Instance.DslEngine!.Register("trim_start_str", "trim_start_str(str)", false, new ExpressionFactoryHelper<StringTrimStartExp>());
            ...
            AgentFrameworkService.Instance.DslEngine!.Register("str_trim_end", "str_trim_end(str)", false, new ExpressionFactoryHelper<StringTrimEndExp>());
            AgentFrameworkService.Instance.DslEngine!.Register("trim_end_str", "trim_end_str(str)", false, new ExpressionFactoryHelper<StringTrimEndExp>());
            ...
            AgentFrameworkService.Instance.DslEngine!.Register("str_to_lower", "str_to_lower(str)", false, new ExpressionFactoryHelper<StringToLowerExp>());
            AgentFrameworkService.Instance.DslEngine!.Register("str_to_upper", "str_to_upper(str)", false, new ExpressionFactoryHelper<StringToUpperExp>());
            AgentFrameworkService.Instance.DslEngine!.Register("to_lower", "to_lower(str)", false, new ExpressionFactoryHelper<StringToLowerExp>());
            AgentFrameworkService.Instance.DslEngine!.Register("to_upper", "to_upper(str)", false, new ExpressionFactoryHelper<StringToUpperExp>());
            AgentFrameworkService.Instance.DslEngine!.Register("string_replace", "string_replace(str, substr, replace[, exactMatch]) exactMatch=true requires exact whitespace; false (default) falls back to trimmed and normalized-whitespace matching", new ExpressionFactoryHelper<StringReplaceExp>());
            AgentFrameworkService.Instance.DslEngine!.Register("replace_string", "replace_string(str, substr, replace[, exactMatch]) exactMatch=true requires exact whitespace; false (default) falls back to trimmed and normalized-whitespace matching", new ExpressionFactoryHelper<StringReplaceExp>());
            AgentFrameworkService.Instance.DslEngine!.Register("str_replace", "str_replace(str, substr, replace[, exactMatch]) exactMatch=true requires exact whitespace; false (default) falls back to trimmed and normalized-whitespace matching", false, new ExpressionFactoryHelper<StringReplaceExp>());
            AgentFrameworkService.Instance.DslEngine!.Register("replace_str", "replace_str(str, substr, replace[, exactMatch]) exactMatch=true requires exact whitespace; false (default) falls back to trimmed and normalized-whitespace matching", false, new ExpressionFactoryHelper<StringReplaceExp>());
            AgentFrameworkService.Instance.DslEngine!.Register("replace", "replace(str, substr, replace[, exactMatch]) exactMatch=true requires exact whitespace; false (default) falls back to trimmed and normalized-whitespace matching", new ExpressionFactoryHelper<StringReplaceExp>());
            ...
            AgentFrameworkService.Instance.DslEngine!.Register("str_replace_char", "str_replace_char(str,key,char_as_str)", false, new ExpressionFactoryHelper<StringReplaceCharExp>());
            ...
            AgentFrameworkService.Instance.DslEngine!.Register("make_str", "make_str(char1_as_str_or_int,char2_as_str_or_int,...)", false, new ExpressionFactoryHelper<MakeStringExp>());
            ...
            AgentFrameworkService.Instance.DslEngine!.Register("str_contains", "str_contains(str,str_or_list_1,str_or_list_2,...)", false, new ExpressionFactoryHelper<StringContainsExp>());
            AgentFrameworkService.Instance.DslEngine!.Register("str_not_contains", "str_not_contains(str,str_or_list_1,str_or_list_2,...)", false, new ExpressionFactoryHelper<StringNotContainsExp>());
            AgentFrameworkService.Instance.DslEngine!.Register("str_contains_any", "str_contains_any(str,str_or_list_1,str_or_list_2,...)", false, new ExpressionFactoryHelper<StringContainsAnyExp>());
            AgentFrameworkService.Instance.DslEngine!.Register("str_not_contains_any", "str_not_contains_any(str,str_or_list_1,str_or_list_2,...)", false, new ExpressionFactoryHelper<StringNotContainsAnyExp>());
            ...
            AgentFrameworkService.Instance.DslEngine!.Register("hex_str_to_uint", "hex_str_to_uint(str)", false, new ExpressionFactoryHelper<Hex2UintExp>());
            ...
            AgentFrameworkService.Instance.DslEngine!.Register("hex_str_to_long", "hex_str_to_long(str)", false, new ExpressionFactoryHelper<Hex2LongExp>());
            ...
            AgentFrameworkService.Instance.DslEngine!.Register("hex_str_to_ulong", "hex_str_to_ulong(str)", false, new ExpressionFactoryHelper<Hex2UlongExp>());
            ...
            AgentFrameworkService.Instance.DslEngine!.Register("get_local_time", "get_local_time() api", new ExpressionFactoryHelper<NowExp>());
            AgentFrameworkService.Instance.DslEngine!.Register("local_time", "local_time() api", false, new ExpressionFactoryHelper<NowExp>());
            AgentFrameworkService.Instance.DslEngine!.Register("get_local_now", "get_local_now() api", false, new ExpressionFactoryHelper<NowExp>());
            AgentFrameworkService.Instance.DslEngine!.Register("local_now", "local_now() api", false, new ExpressionFactoryHelper<NowExp>());
            ...
            AgentFrameworkService.Instance.DslEngine!.Register("parse_datetime", "parse_datetime(str) api", false, new ExpressionFactoryHelper<ParseDateTimeExp>());
            AgentFrameworkService.Instance.DslEngine!.Register("parse_date", "parse_date(str) api", false, new ExpressionFactoryHelper<ParseDateTimeExp>());
            AgentFrameworkService.Instance.DslEngine!.Register("parse_time", "parse_time(str) api", false, new ExpressionFactoryHelper<ParseDateTimeExp>());
            ...
            AgentFrameworkService.Instance.DslEngine!.Register("format_datetime", "format_datetime(fmt,datetime) api", false, new ExpressionFactoryHelper<FormatDateTimeExp>());
            AgentFrameworkService.Instance.DslEngine!.Register("format_date", "format_date(fmt,datetime) api", false, new ExpressionFactoryHelper<FormatDateTimeExp>());
            AgentFrameworkService.Instance.DslEngine!.Register("format_time", "format_time(fmt,datetime) api", false, new ExpressionFactoryHelper<FormatDateTimeExp>());
            AgentFrameworkService.Instance.DslEngine!.Register("date_time_format", "date_time_format(fmt,datetime)", false, new ExpressionFactoryHelper<FormatDateTimeExp>());
            AgentFrameworkService.Instance.DslEngine!.Register("datetime_format", "datetime_format(fmt,datetime)", false, new ExpressionFactoryHelper<FormatDateTimeExp>());
            ...
            AgentFrameworkService.Instance.DslEngine!.Register("time_format", "time_format(fmt,datetime)", false, new ExpressionFactoryHelper<FormatDateTimeExp>());
            ...
            AgentFrameworkService.Instance.DslEngine!.Register("isdirectory", "isdirectory(path)", false, new ExpressionFactoryHelper<DirectoryExistsExp>());
