...
namespace CefDotnetApp.AgentCore
{
    ...
    public static class ScriptApiRegistrar
    {
        ...
        public static void RegisterAllApis()
        {
            ...
            AgentFrameworkService.Instance.DslEngine!.Register("search_log_file_as_list", "search_log_file_as_list(log_file, search_regex[, context_lines_after, context_lines_before]) return List of MatchBlock(FilePath/StartLine/EndLine/MatchedCount/Text fields, supports LINQ such as .where($$.MatchedCount > 1)), use 'to_string' to convert to a string", new ExpressionFactoryHelper<SearchLogFileAsListExp>());
            AgentFrameworkService.Instance.DslEngine!.Register("grep_log_file_as_list", "grep_log_file_as_list(log_file, search_regex[, context_lines_after, context_lines_before]) return List of MatchBlock(FilePath/StartLine/EndLine/MatchedCount/Text fields, supports LINQ such as .where($$.MatchedCount > 1)), use 'to_string' to convert to a string", new ExpressionFactoryHelper<SearchLogFileAsListExp>());
            ...
            AgentFrameworkService.Instance.DslEngine!.Register("readlines", "readlines(path, startLine, endLine) return List, use 'to_string' to convert to a string", false, new ExpressionFactoryHelper<ReadLinesExp>());
            ...
            AgentFrameworkService.Instance.DslEngine!.Register("search_in_file_as_list", "search_in_file_as_list(path, regex_pattern[, context_lines_after, context_lines_before]) return List of MatchBlock(FilePath/StartLine/EndLine/MatchedCount/Text fields, supports LINQ such as .where($$.MatchedCount > 1)), use 'to_string' to convert to a string", new ExpressionFactoryHelper<SearchInFileAsListExp>());
            AgentFrameworkService.Instance.DslEngine!.Register("grep_file_as_list", "grep_file_as_list(path, regex_pattern[, context_lines_after, context_lines_before]) return List of MatchBlock(FilePath/StartLine/EndLine/MatchedCount/Text fields, supports LINQ such as .where($$.MatchedCount > 1)), use 'to_string' to convert to a string", new ExpressionFactoryHelper<SearchInFileAsListExp>());
            AgentFrameworkService.Instance.DslEngine!.Register("grepfileaslist", "grepfileaslist(path, regex_pattern[, context_lines_after, context_lines_before]) return List of MatchBlock(FilePath/StartLine/EndLine/MatchedCount/Text fields, supports LINQ such as .where($$.MatchedCount > 1)), use 'to_string' to convert to a string", false, new ExpressionFactoryHelper<SearchInFileAsListExp>());
