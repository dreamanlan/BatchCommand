...
namespace Brace
{
    ...
    enum BraceDataTypeEnum
    {
        ...
        BRACE_DATA_TYPE_UOBJECT,
        BRACE_DATA_TYPE_NUM
    };
    enum BraceObjectClassEnum
    {
    ...
    {
    public:
        virtual int GetClassType(void)const { return BRACE_OBJECT_UNKNOWN; }
    public:
    ...
    struct VariableInfo final
    {
        ...
        std::vector<UObject*> UObjectVars;
    ...
    protected:
        ...
        virtual bool LoadCall(const std::vector<BraceApiExecutor>& args, const std::vector<BraceApiLoadInfo>& argLoadInfos, BraceApiLoadInfo& loadInfo, BraceApiExecutor& executor)
        {
            return false;
        }
    protected:
