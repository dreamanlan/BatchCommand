  ...
  constructor() {
    ...
    this.defaults = {
      ...
      panel: {
        ...
        // How often the inject side asks the dsl whether the renderer process
        // is over its memory limit (seconds). The verdict itself comes from the
        // dsl, which is the only side that can read a process level figure.
        memoryGuardIntervalSec: 60,
