vs
{
    ...
    shader_arg
    {
        vs_attr("d:/UC/depth1/vs_in.csv", "d:/UC/depth1/vs_out.csv", 0);
    };
    calculator
    {
...
ps
{
    ...
    shader_arg
    {
        ps_attr("d:/UC/depth1/vs_out.csv", 0){
            map_in_attr("out_attr0","in_attr0");
            remove_in_attr("gl_Position");
        };
        uniform("d:/UC/depth1/fs_cbuf0.csv", "uvec4"){
            add(81);
        };
        uniform("d:/UC/depth1/fs_cbuf3.csv", "uvec4"){
            add(0,1);
        };
    };
    calculator
