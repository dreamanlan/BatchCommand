void vert_from_glsl(appdata v, vaodata i, inout v2f o)
{
	...
	// 1143873536  <=>  {u_8_phi_9 : 1143873536}
	u_6_4 = u_8_phi_9;
	u_6_phi_11 = u_6_4;
	// False  <=>  if(((((({i.vao_attr4.w : 696.50} > {(vs_cbuf10_2.x) : 879.50}) && (! myIsNaN({i.vao_attr4.w : 696.50}))) && (! myIsNaN({(vs_cbuf10_2.x) : 879.50}))) || ((({pf_0_1 : 183.00} >= float(int((myIsNaN({i.vao_attr3.w : 600.00}) ? 0u : int(clamp(trunc({i.vao_attr3.w : 600.00}), float(-2147483600.f), float(2147483600.f))))))) && (! myIsNaN({pf_0_1 : 183.00}))) && (! myIsNaN(float(int((myIsNaN({i.vao_attr3.w : 600.00}) ? 0u : int(clamp(trunc({i.vao_attr3.w : 600.00}), float(-2147483600.f), float(2147483600.f)))))))))) ? true : false))
	if((((((i.vao_attr4.w > (vs_cbuf10_2.x)) && (! myIsNaN(i.vao_attr4.w))) && (! myIsNaN((vs_cbuf10_2.x)))) || (((pf_0_1 >= float(int((myIsNaN(i.vao_attr3.w) ? 0u : int(clamp(trunc(i.vao_attr3.w), float(-2147483600.f), float(2147483600.f))))))) && (! myIsNaN(pf_0_1))) && (! myIsNaN(float(int((myIsNaN(i.vao_attr3.w) ? 0u : int(clamp(trunc(i.vao_attr3.w), float(-2147483600.f), float(2147483600.f)))))))))) ? true : false))
	...
	// 1191460864  <=>  {u_10_phi_15 : 1191460864}
	u_11_1 = u_10_phi_15;
	u_11_phi_16 = u_11_1;
	// True  <=>  if((((({utof(vs_cbuf9[15].x) : 1.00} == 1.f) && (! myIsNaN({utof(vs_cbuf9[15].x) : 1.00}))) && (! myIsNaN(1.f))) ? true : false))
	if(((((utof(vs_cbuf9[15].x) == 1.f) && (! myIsNaN(utof(vs_cbuf9[15].x)))) && (! myIsNaN(1.f))) ? true : false))
	...
	// 1061462412  <=>  {u_30_phi_46 : 1061462412}
	u_33_2 = u_30_phi_46;
	// 1061462412  <=>  {u_28_phi_44 : 1061462412}
	u_34_0 = u_28_phi_44;
	// 1043157630  <=>  {u_29_phi_45 : 1043157630}
	u_35_0 = u_29_phi_45;
	// 1043157630  <=>  {u_27_phi_43 : 1043157630}
	u_36_0 = u_27_phi_43;
	u_33_phi_47 = u_33_2;
	u_34_phi_47 = u_34_0;
	u_35_phi_47 = u_35_0;
	...
	if(((! (u_21_phi_41 == 1u)) ? true : false))
	{
		...
		// 1061462412  <=>  {u_39_phi_51 : 1061462412}
		u_33_3 = u_39_phi_51;
		// 1061462412  <=>  {u_37_phi_49 : 1061462412}
		u_34_1 = u_37_phi_49;
		// 1043157630  <=>  {u_38_phi_50 : 1043157630}
		u_35_1 = u_38_phi_50;
		// 1043157630  <=>  {u_21_phi_48 : 1043157630}
		u_36_1 = u_21_phi_48;
		u_33_phi_47 = u_33_3;
		u_34_phi_47 = u_34_1;
		u_35_phi_47 = u_35_1;
	...
	// 1063807028  <=>  {u_26_phi_53 : 1063807028}
	u_35_2 = u_26_phi_53;
	// 1043157630  <=>  {u_29_phi_54 : 1043157630}
	u_37_16 = u_29_phi_54;
	// 1063807028  <=>  {u_33_phi_56 : 1063807028}
	u_39_12 = u_33_phi_56;
	// 1043157630  <=>  {u_34_phi_57 : 1043157630}
	u_41_1 = u_34_phi_57;
	// 1061462412  <=>  {u_32_phi_55 : 1061462412}
	u_42_0 = u_32_phi_55;
	u_35_phi_58 = u_35_2;
	u_37_phi_58 = u_37_16;
	u_39_phi_58 = u_39_12;
	...
	if(((! (u_40_phi_52 == 1u)) ? true : false))
	{
		...
		// 1061462412  <=>  {u_40_phi_59 : 1061462412}
		u_35_3 = u_40_phi_59;
		// 1063807028  <=>  {u_6_phi_60 : 1063807028}
		u_37_17 = u_6_phi_60;
		// 1063807028  <=>  {u_44_phi_62 : 1063807028}
		u_39_13 = u_44_phi_62;
		// 1043157630  <=>  {u_8_phi_63 : 1043157630}
		u_41_2 = u_8_phi_63;
		// 1043157630  <=>  {u_43_phi_61 : 1043157630}
		u_42_1 = u_43_phi_61;
		u_35_phi_58 = u_35_3;
		u_37_phi_58 = u_37_17;
		u_39_phi_58 = u_39_13;
	...
	// 3207546337  <=>  {u_2_phi_64 : 3207546337}
	u_1_18 = u_2_phi_64;
	u_1_phi_66 = u_1_18;
	...
	// 1165623296  <=>  {u_1_phi_77 : 1165623296}
	u_5_26 = u_1_phi_77;
	u_5_phi_78 = u_5_26;
	// True  <=>  if(({b_1_67 : True} ? true : false))
	if((b_1_67 ? true : false))
