...
vs
{
    ...
    shader_arg
    {
        vs_attr("d:/UC/simple_light_smoke3/vs_in.csv", "d:/UC/simple_light_smoke3/vs_out.csv", 0);
        uniform("d:/UC/simple_light_smoke3/vs_cbuf0.csv", "uvec4"){
            add(21);
        };
        uniform("d:/UC/simple_light_smoke3/vs_cbuf8.csv", "uvec4"){
            add(10,11,28,29,30);
            add_range(0,7);
        };
        uniform("d:/UC/simple_light_smoke3/vs_cbuf9.csv", "uvec4"){
            add(194,195,196,197);
            add_range(0, 160);
        };
        uniform("d:/UC/simple_light_smoke3/vs_cbuf10.csv", "uvec4"){
            add_range(0,6);
        };
        uniform("d:/UC/simple_light_smoke3/vs_cbuf13.csv", "uvec4"){
            add(0,1,2,3,5,6);
        };
        uniform("d:/UC/simple_light_smoke3/vs_cbuf15.csv", "uvec4"){
            add(49,51,52,58);
            add_range(22,28);
        };
        uniform("d:/UC/simple_light_smoke3/vs_cbuf16.csv", "uvec4"){
            add(0,1);
        };
        vao_attr("private Vector4[] in_attr3_array", "vec4", "d:/uc/VAO_simple_light_smoke3/vertex_in_attr3.csv", "[NonSerialized]"){
            add_range(0,101);
        };
        vao_attr("private Vector4[] in_attr4_array", "vec4", "d:/uc/VAO_simple_light_smoke3/vertex_in_attr4.csv", "[NonSerialized]"){
            add_range(0,101);
        };
        vao_attr("private Vector4[] in_attr5_array", "vec4", "d:/uc/VAO_simple_light_smoke3/vertex_in_attr5.csv", "[NonSerialized]"){
            add_range(0,101);
        };
        vao_attr("private Vector4[] in_attr6_array", "vec4", "d:/uc/VAO_simple_light_smoke3/vertex_in_attr6.csv", "[NonSerialized]"){
            add_range(0,101);
        };
        vao_attr("private Vector4[] in_attr8_array", "vec4", "d:/uc/VAO_simple_light_smoke3/vertex_in_attr8.csv", "[NonSerialized]"){
            add_range(0,101);
        };
        vao_attr("private Vector4[] in_attr9_array", "vec4", "d:/uc/VAO_simple_light_smoke3/vertex_in_attr9.csv", "[NonSerialized]"){
            add_range(0,101);
        };
        vao_attr("private Vector4[] in_attr10_array", "vec4", "d:/uc/VAO_simple_light_smoke3/vertex_in_attr10.csv", "[NonSerialized]"){
            add_range(0,101);
        };
    ...
    shader_arg(1)
    {
        redirect(0, "d:/UC/simple_light_smoke3/1", "d:/uc/VAO_simple_light_smoke3/1");
    };
    shader_arg(2)
    {
        redirect(0, "d:/UC/simple_light_smoke3/2", "d:/uc/VAO_simple_light_smoke3/2");
    };
    shader_arg(3)
    {
        redirect(0, "d:/UC/simple_light_smoke3/3", "d:/uc/VAO_simple_light_smoke3/3");
    };
    shader_arg(4)
    {
        redirect(0, "d:/UC/simple_light_smoke3/4", "d:/uc/VAO_simple_light_smoke3/4");
    };
    shader_arg(5)
    {
        redirect(0, "d:/UC/simple_light_smoke3/5", "d:/uc/VAO_simple_light_smoke3/5");
    };
    type_replacement
    {
        vs_cbuf0 = float;
...
ps
{
    ...
    shader_arg
    {
        ps_attr("d:/UC/simple_light_smoke3/vs_out.csv", 0){
        ...
        uniform("d:/UC/simple_light_smoke3/fs_cbuf8.csv", "uvec4"){
            add(30);
        };
        uniform("d:/UC/simple_light_smoke3/fs_cbuf9.csv", "uvec4"){
            add(19,139,140);
        };
        uniform("d:/UC/simple_light_smoke3/fs_cbuf13.csv", "uvec4"){
            add(0);
        };
        uniform("d:/UC/simple_light_smoke3/fs_cbuf15.csv", "uvec4"){
            add(1,25,26,39);
        };
    };
    shader_arg(1)
