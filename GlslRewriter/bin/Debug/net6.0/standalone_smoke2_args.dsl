vs
{
    ...
    shader_arg
    {
        ...
        uniform("d:/UC/standalone_smoke2/vs_cbuf16.csv", "uvec4"){
            add(0,1);
        };
        vao_attr("private Vector4[] in_attr3_array", "vec4", "d:/uc/VAO_standalone_smoke2/vertex_in_attr3.csv", "[NonSerialized]"){
            add_range(0,34);
        };
        ...
        vao_attr("private Vector4[] in_attr8_array", "vec4", "d:/uc/VAO_standalone_smoke2/vertex_in_attr8.csv", "[NonSerialized]"){
            add_range(0,34);
        };
