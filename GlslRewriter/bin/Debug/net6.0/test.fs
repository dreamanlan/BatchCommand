...
layout(location = 0) in vec4 in_attr0; //(ֻ��w)
layout(location = 1) in vec4 in_attr1; //(xyzwȫ��)
layout(location = 2) in vec4 in_attr2; //(xyzwȫ��)
layout(location = 3) in vec4 in_attr3; //(ֻ��x)
layout(location = 4) in vec4 in_attr4; //(��xyz)
layout(location = 5) flat in vec4 in_attr5; //(ֻ��y)
layout(location = 6) flat in vec4 in_attr6; //(ֻ��x)
layout(location = 7) in vec4 in_attr7; //(��xy)
layout(location = 8) in vec4 in_attr8; //(��xz)
layout(location = 9) in vec4 in_attr9; //(xyzwȫ��)
layout(location = 10) in vec4 in_attr10; //(xyzwȫ��)
layout(location = 11) in vec4 in_attr11; //(xyzwȫ��)
