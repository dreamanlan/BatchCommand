...
in_attr0.x = float(0.89921);
in_attr0.y = float(0.89488);
in_attr0.z = float(0.8207);
in_attr0.w = float(0.10);
in_attr1.x = float(0.43533);
in_attr1.y = float(0.50728);
in_attr1.z = float(0.53254);
in_attr1.w = float(0.16319);
in_attr2.x = float(1.88471);
in_attr2.y = float(4.63278);
in_attr2.z = float(-0.22447);
in_attr2.w = float(0.99756);
in_attr3.x = float(0.94197);
in_attr3.y = float(0.82298);
in_attr3.z = float(0.00);
in_attr3.w = float(1.00);
in_attr4.x = float(32.13303);
in_attr4.y = float(29.0226);
in_attr4.z = float(70.2599);
in_attr4.w = float(70.35962);
...
fs_cbuf9[140] = uvec4(1065353216, 1101004800, 0, 0);
fs_cbuf13[0] = uvec4(0, 1056964608, 1065353216, 1065353216);
