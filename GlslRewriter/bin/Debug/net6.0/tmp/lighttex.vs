...
out_attr0.x = float(6360.12646);
out_attr0.y = float(0.00);
out_attr0.z = float(0.00);
out_attr0.w = float(1.00);
out_attr1.x = float(-0.00631);
out_attr1.y = float(0.00);
out_attr1.z = float(0.00);
out_attr1.w = float(1.00);
out_attr2.x = float(-0.0024);
out_attr2.y = float(0.00);
out_attr2.z = float(0.00);
out_attr2.w = float(1.00);
vs_cbuf3[2] = uvec4(1132462080, 1132462080, 998244352, 998244352);
vs_cbuf3[8] = uvec4(1170653184, 1170776064, 0, 0);
vs_cbuf4[3] = uvec4(1099956224, 1099216056, 1098173645, 990502934);
vs_cbuf4[7] = uvec4(0, 0, 0, 0);
  bool b_0 = bool(0);
  bool b_1 = bool(0);
  uint u_0 = uint(0);
  uint u_1 = uint(0);
