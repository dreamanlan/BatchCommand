...
void main() {
gl_FragCoord = vec4(-160999.34, 11557.13, 704.58405, 1410.0554);
in_attr0.x = float(1.47143);
in_attr0.y = float(1.46435);
in_attr0.z = float(1.34297);
in_attr0.w = float(0.10);
in_attr1.x = float(0.61871);
in_attr1.y = float(0.70002);
in_attr1.z = float(0.72857);
in_attr1.w = float(0.292);
in_attr2.x = float(1.64633);
in_attr2.y = float(3.99861);
in_attr2.z = float(1.33209);
in_attr2.w = float(0.98535);
in_attr3.x = float(0.27337);
in_attr3.y = float(0.98344);
in_attr3.z = float(0.00);
in_attr3.w = float(1.00);
in_attr4.x = float(73.15771);
in_attr4.y = float(660.20563);
in_attr4.z = float(1409.11182);
in_attr4.w = float(1410.05542);
...
in_attr8.x = float(-0.66292);
in_attr8.y = float(0.1409);
in_attr8.z = float(-0.73557);
in_attr8.w = float(1.00);
in_attr9.x = float(1.00);
in_attr9.y = float(0.00);
in_attr9.z = float(0.00);
in_attr9.w = float(1.00);
in_attr10.x = float(0.65067);
in_attr10.y = float(0.26066);
in_attr10.z = float(0.00);
in_attr10.w = float(0.00);
in_attr11.x = float(0.0923);
in_attr11.y = float(0.0923);
in_attr11.z = float(0.0923);
in_attr11.w = float(1.00);
in_attr12.x = float(0.00071);
in_attr12.y = float(0.00464);
in_attr12.z = float(0.00445);
in_attr12.w = float(0.49591);
fs_cbuf8[30] = uvec4(1065353216, 1187205120, 1187205120, 1187204608);
fs_cbuf9[19] = uvec4(1036831949, 1036831949, 0, 0);
fs_cbuf9[139] = uvec4(1065353216, 0, 0, 0);
fs_cbuf9[140] = uvec4(1065353216, 1133903872, 0, 0);
fs_cbuf13[0] = uvec4(0, 1056964608, 1065353216, 1056964608);
fs_cbuf15[1] = uvec4(0, 0, 1074936538, 1045220556);
fs_cbuf15[25] = uvec4(1026969997, 1038318822, 1040508547, 1059492467);
fs_cbuf15[26] = uvec4(1020940734, 1040446532, 1045045907, 1048933607);
  bool b_0 = bool(0);
  bool b_1 = bool(0);
  uint u_0 = uint(0);
  uint u_1 = uint(0);
