...
void main() {
gl_FragCoord = vec4(-15468.5205, 14143.316, 83.12576, 165.4502);
...
in_attr1.w = float(0.14317);
in_attr2.x = float(0.81006);
in_attr2.y = float(3.93004);
in_attr2.z = float(-0.26864);
in_attr2.w = float(0.98535);
in_attr3.x = float(0.89506);
in_attr3.y = float(0.85918);
in_attr3.z = float(0.00);
in_attr3.w = float(1.00);
in_attr4.x = float(21.56423);
in_attr4.y = float(27.76111);
in_attr4.z = float(165.35086);
in_attr4.w = float(165.4502);
...
in_attr10.x = float(0.63252);
in_attr10.y = float(0.00);
in_attr10.z = float(0.00);
in_attr10.w = float(0.4995);
in_attr11.x = float(0.06766);
in_attr11.y = float(0.06766);
in_attr11.z = float(0.06766);
in_attr11.w = float(1.00);
in_attr12.x = float(0.00111);
in_attr12.y = float(0.00877);
in_attr12.z = float(0.00901);
in_attr12.w = float(0.11393);
