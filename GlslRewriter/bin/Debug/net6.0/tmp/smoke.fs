...
in_attr2.x = float(0.63971);
in_attr2.y = float(0.43186);
in_attr2.z = float(-0.94371);
in_attr2.w = float(2.0161);
in_attr3.x = float(0.39765);
in_attr3.y = float(0.74824);
in_attr3.z = float(0.00);
in_attr3.w = float(1.00);
in_attr4.x = float(-0.25307);
in_attr4.y = float(6.17158);
in_attr4.z = float(0.6654);
in_attr4.w = float(1.66537);
in_attr5.x = float(0.15);
in_attr5.y = float(0.60);
in_attr5.z = float(0.00);
in_attr5.w = float(1.00);
in_attr6.x = float(0.01423);
in_attr6.y = float(0.00);
in_attr6.z = float(0.00);
in_attr6.w = float(1.00);
in_attr7.x = float(-1.38554);
in_attr7.y = float(-1.56071);
in_attr7.z = float(-0.35505);
in_attr7.w = float(1.00);
in_attr8.x = float(10.44641);
...
in_attr10.x = float(0.0037);
in_attr10.y = float(0.00);
in_attr10.z = float(0.00);
in_attr10.w = float(0.00);
in_attr11.x = float(0.56953);
in_attr11.y = float(0.6097);
in_attr11.z = float(0.45109);
in_attr11.w = float(1.00);
in_attr12.x = float(0.02773);
in_attr12.y = float(0.07339);
in_attr12.z = float(0.17461);
in_attr12.w = float(0.00188);
...
fs_cbuf15[1] = uvec4(0, 0, 1069684480, 1065353216);
fs_cbuf15[25] = uvec4(1058390671, 1065353216, 1062098436, 1043060028);
