...
void main() {
gl_FragCoord = vec4(-116523.766, 3802.9783, 270.52594, 540.24756);
in_attr0.x = float(0.21188);
in_attr0.y = float(0.22817);
in_attr0.z = float(0.22779);
in_attr0.w = float(1.00);
in_attr1.x = float(0.1241);
in_attr1.y = float(0.13335);
in_attr1.z = float(0.14087);
in_attr1.w = float(1.00);
in_attr2.x = float(0.9785);
in_attr2.y = float(0.50196);
in_attr2.z = float(-0.05795);
in_attr2.w = float(-0.30511);
in_attr3.x = float(0.50196);
in_attr3.y = float(-2.49902);
in_attr3.z = float(0.00);
in_attr3.w = float(1.00);
in_attr4.x = float(-187.33215);
in_attr4.y = float(255.71014);
in_attr4.z = float(540.14972);
in_attr4.w = float(540.24756);
in_attr5.x = float(0.3291);
in_attr5.y = float(0.00);
in_attr5.z = float(0.00);
in_attr5.w = float(1.00);
in_attr6.x = float(-0.66977);
in_attr6.y = float(0.00);
in_attr6.z = float(-0.74257);
...
fs_cbuf15[26] = vec4(0.0174636, 0.1221582, 0.2193998, 0.20);
  ...
  f_7 = float(u_0);
  f_8 = float(u_1);
  pf_0 = f_7 * 0.00390625f;
  pf_1 = f_8 * 0.00390625f;
  f_7 = min(pf_0, 2.f);
  f_8 = in_attr3.x;
  f_9 = min(pf_1, 2.f);
  f2_0 = vec2(f_0, f_1);
  ...
  pf_1 = f_10 * f_6;
  f_5 = in_attr0.w;
  f_6 = utof(fs_cbuf8[30].y);
  f_10 = utof(fs_cbuf8[30].w);
  f_6 = 0.f - (f_6);
  pf_1 = fma(pf_1, f_10, f_6);
  f_6 = utof(fs_cbuf8[30].x);
  f_10 = utof(fs_cbuf8[30].w);
  pf_2 = fma(f_4, f_10, f_6);
  f_4 = in_attr5.x;
  u_2 = ftou(f_4);
  f_6 = (1.0f) / pf_1;
  f_10 = utof(fs_cbuf8[30].z);
  pf_1 = fma(f_6, f_10, pf_2);
  pf_1 = pf_1 * f_8;
  f_6 = min(max(pf_1, 0.0), 1.0);
  pf_0 = pf_0 * f_5;
  f_5 = min(max(pf_0, 0.0), 1.0);
  pf_0 = f_6 * f_5;
  u_3 = ftou(pf_0);
  pf_0 = pf_0 * f_4;
  f_4 = utof(fs_cbuf9[139].z);
  b_0 = pf_0 <= f_4 && !isnan(pf_0) && !isnan(f_4);
  b_1 = b_0 ? ( true ) : ( false);
  if (b_1) {
    discard;
  }
  ...
  f_8 = 0.f - (f_2);
  pf_4 = f_8 + f_6;
  pf_2 = fma(pf_2, pf_4, f_2);
  pf_3 = fma(f_9, f_9, pf_3);
  f_2 = 0.f - (f_3);
  pf_4 = f_2 + f_5;
  f_2 = in_attr9.x;
  ...
  f_5 = in_attr9.z;
  f_6 = 0.f - (f_7);
  pf_4 = fma(f_0, f_6, f_0);
  f_0 = 0.f - (f_7);
  pf_5 = fma(f_1, f_0, f_1);
  f_0 = 0.f - (f_7);
  pf_6 = fma(f_4, f_0, f_4);
  f_0 = in_attr10.w;
  f_1 = utof(fs_cbuf13[0].y);
  pf_4 = pf_4 * f_1;
  f_1 = in_attr8.y;
  f_4 = utof(fs_cbuf13[0].y);
  pf_5 = pf_5 * f_4;
  f_4 = utof(fs_cbuf13[0].y);
  pf_6 = pf_6 * f_4;
  f_4 = utof(fs_cbuf15[1].w);
  pf_4 = fma(pf_4, f_4, f_2);
  f_2 = utof(fs_cbuf15[1].w);
  pf_5 = fma(pf_5, f_2, f_3);
  f_2 = in_attr8.x;
  f_3 = utof(fs_cbuf15[1].w);
  pf_6 = fma(pf_6, f_3, f_5);
  f_3 = in_attr10.z;
  pf_7 = pf_1 * pf_4;
  f_4 = utof(fs_cbuf15[26].x);
  f_5 = 0.f - (pf_4);
  pf_1 = fma(pf_1, f_5, f_4);
  f_4 = in_attr10.y;
  pf_4 = pf_2 * pf_5;
  f_5 = utof(fs_cbuf15[26].y);
  f_6 = 0.f - (pf_5);
  pf_2 = fma(pf_2, f_6, f_5);
  f_5 = in_attr10.x;
  pf_5 = pf_3 * pf_6;
  f_6 = utof(fs_cbuf15[26].z);
  f_7 = 0.f - (pf_6);
  pf_3 = fma(pf_3, f_7, f_6);
  f_6 = in_attr7.x;
  pf_1 = fma(pf_1, f_1, pf_7);
  pf_2 = fma(pf_2, f_1, pf_4);
  pf_3 = fma(pf_3, f_1, pf_5);
  f_1 = 0.f - (pf_3);
  pf_4 = f_1 + f_3;
  f_1 = 0.f - (pf_2);
  pf_5 = f_1 + f_4;
  ...
  f_1 = 0.f - (pf_1);
  pf_6 = f_1 + f_0;
  pf_1 = fma(pf_6, f_2, pf_1);
  pf_2 = fma(pf_5, f_2, pf_2);
  pf_3 = fma(pf_4, f_2, pf_3);
  pf_1 = pf_1 * f_6;
  pf_2 = pf_2 * f_6;
  pf_3 = pf_3 * f_6;
