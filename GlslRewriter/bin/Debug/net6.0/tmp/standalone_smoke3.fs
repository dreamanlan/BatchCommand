...
void main() {
gl_FragCoord = vec4(127.5, 127.5, 62500.5, 27.38721);
in_attr0.x = float(1.09333);
in_attr0.y = float(1.07386);
in_attr0.z = float(0.96317);
in_attr0.w = float(0.00147);
in_attr1.x = float(0.00);
in_attr1.y = float(0.00);
in_attr1.z = float(0.00);
in_attr1.w = float(2.10);
in_attr2.x = float(-0.13084);
in_attr2.y = float(1.70043);
in_attr2.z = float(0.74605);
in_attr2.w = float(0.92636);
in_attr3.x = float(17.3302);
in_attr3.y = float(10.47894);
in_attr3.z = float(27.28732);
in_attr3.w = float(27.38721);
...
in_attr6.x = float(-0.4113);
in_attr6.y = float(-0.14099);
in_attr6.z = float(-0.90012);
...
in_attr9.x = float(0.51474);
in_attr9.y = float(0.58878);
in_attr9.z = float(0.60599);
...
fs_cbuf15[1] = vec4(0.00, 0.00, 2.594247, 0.20);
  ...
  f_2 = utof(fs_cbuf8[30].w);
  pf_1 = fma(f_0, f_2, f_1);
  pf_0 = pf_0 * f_5;
  f_0 = utof(fs_cbuf8[30].z);
  pf_1 = fma(f_3, f_0, pf_1);
  pf_0 = pf_0 * f_6;
  ...
  pf_4 = fma(pf_4, f_0, f_10);
  f_0 = utof(fs_cbuf15[1].w);
  pf_5 = fma(pf_5, f_0, f_3);
  f_0 = utof(fs_cbuf15[1].w);
  pf_6 = fma(pf_6, f_0, f_4);
  pf_1 = pf_1 * pf_4;
  pf_2 = pf_2 * pf_5;
  pf_3 = pf_3 * pf_6;
  pf_1 = pf_1 * f_5;
