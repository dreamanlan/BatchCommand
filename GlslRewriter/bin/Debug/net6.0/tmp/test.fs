...
void main() {
gl_FragCoord = vec4(21350.924, 99298.38, 630.4733, 1261.8458);
...
in_attr1.z = float(1.46396);
in_attr1.w = float(3.26268);
in_attr2.x = float(714.15204);
in_attr2.y = float(242.01749);
in_attr2.z = float(1260.89624);
in_attr2.w = float(1261.84583);
in_attr3.x = float(1.00);
in_attr3.y = float(0.00);
in_attr3.z = float(0.00);
in_attr3.w = float(1.00);
in_attr4.x = float(564.69989);
in_attr4.y = float(1268.1571);
in_attr4.z = float(170.82373);
...
in_attr10.x = float(4.77344);
in_attr10.y = float(3.10352);
in_attr10.z = float(1.75391);
in_attr10.w = float(0.00);
in_attr11.x = float(0.20251);
in_attr11.y = float(0.44214);
in_attr11.z = float(0.8335);
