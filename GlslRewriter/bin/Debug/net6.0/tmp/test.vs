...
in_attr4.x = float(-1195.75366);
in_attr4.y = float(8.77148);
in_attr4.z = float(157.85321);
in_attr4.w = float(1000.00);
in_attr5.x = float(0.00);
in_attr5.y = float(0.00);
in_attr5.z = float(0.00);
in_attr5.w = float(1140.00);
in_attr6.x = float(298.55466);
in_attr6.y = float(204.01236);
in_attr6.z = float(204.01236);
in_attr6.w = float(1.00);
in_attr7.x = float(0.26717);
in_attr7.y = float(0.9981);
in_attr7.z = float(0.25713);
in_attr7.w = float(0.27358);
in_attr9.x = float(1.00);
in_attr9.y = float(0.00);
in_attr9.z = float(0.00);
in_attr9.w = float(370.26007);
in_attr10.x = float(0.00);
in_attr10.y = float(1.00);
in_attr10.z = float(0.00);
in_attr10.w = float(1781.30017);
in_attr11.x = float(0.00);
in_attr11.y = float(0.00);
in_attr11.z = float(1.00);
in_attr11.w = float(-2756.83838);
gl_Position.x = float(-659.24261);
gl_Position.y = float(620.32874);
gl_Position.z = float(1043.23743);
gl_Position.w = float(1045.15393);
...
out_attr1.z = float(1.25044);
out_attr1.w = float(2.99478);
out_attr2.x = float(192.95566);
out_attr2.y = float(212.4126);
out_attr2.z = float(1044.19568);
out_attr2.w = float(1045.15393);
out_attr3.x = float(1.00);
out_attr3.y = float(0.00);
out_attr3.z = float(0.00);
out_attr3.w = float(1.00);
out_attr4.x = float(-825.49359);
out_attr4.y = float(1790.07166);
out_attr4.z = float(-2598.98511);
out_attr4.w = float(1.00);
out_attr5.x = float(0.00);
out_attr5.y = float(204.01236);
...
out_attr8.x = float(0.50);
out_attr8.y = float(0.00);
out_attr8.z = float(1.00);
out_attr8.w = float(1.00);
out_attr9.x = float(0.3169);
out_attr9.y = float(0.58655);
out_attr9.z = float(1.04589);
out_attr9.w = float(0.24638);
out_attr10.x = float(2.18164);
out_attr10.y = float(2.19922);
out_attr10.z = float(1.9375);
out_attr10.w = float(0.00);
out_attr11.x = float(0.14075);
out_attr11.y = float(0.39575);
out_attr11.z = float(1.02051);
out_attr11.w = float(0.00);
vs_cbuf8[0] = uvec4(1051345609, 838864273, 3211882054, 3307876640);
vs_cbuf8[1] = uvec4(3200011897, 1064024848, 3187985404, 3304716109);
vs_cbuf8[2] = uvec4(1063145637, 1053272963, 1050462135, 3278276851);
...
vs_cbuf8[29] = uvec4(1136206159, 1156671898, 3308014955, 0);
...
vs_cbuf10[2] = uvec4(1155301376, 1126105088, 1065353216, 1065353216);
vs_cbuf10[3] = uvec4(1065353166, 1065353216, 1065353216, 1065353216);
vs_cbuf13[6] = uvec4(1065353216, 1065353216, 1092616192, 0);
vs_cbuf15[1] = uvec4(0, 1065353216, 1068152888, 1065353216);
vs_cbuf15[22] = uvec4(942646288, 1000647119, 0, 0);
vs_cbuf15[23] = uvec4(1141309440, 1075838976, 1062836634, 3167343845);
...
vs_cbuf15[28] = uvec4(3193867251, 3207087382, 3208166229, 0);
vs_cbuf15[54] = uvec4(1053626554, 1070585234, 1117126656, 1157234688);
vs_cbuf15[55] = uvec4(1053609165, 1058642330, 1065353216, 1058642330);
vs_cbuf15[57] = uvec4(1141589745, 3291738805, 1161527296, 1065353216);
vs_cbuf15[60] = uvec4(1061158912, 1056964608, 1082130432, 1156671899);
