...
in_attr1.z = float(3.71869);
in_attr1.w = float(4.64137);
in_attr2.x = float(36.32253);
in_attr2.y = float(314.42813);
in_attr2.z = float(471.52112);
in_attr2.w = float(472.50229);
in_attr3.x = float(1.00);
in_attr3.y = float(0.00);
in_attr3.z = float(0.00);
in_attr3.w = float(1.00);
in_attr4.x = float(-139.8017);
in_attr4.y = float(1709.50635);
in_attr4.z = float(-2585.21094);
in_attr4.w = float(1.00);
in_attr5.x = float(0.00);
in_attr5.y = float(164.02721);
...
in_attr9.x = float(0.08615);
in_attr9.y = float(0.12922);
in_attr9.z = float(0.21537);
in_attr9.w = float(0.78463);
in_attr10.x = float(0.21094);
in_attr10.y = float(0.94818);
in_attr10.z = float(0.00);
in_attr10.w = float(1.00);
in_attr11.x = float(2.61328);
in_attr11.y = float(2.38672);
in_attr11.z = float(2.01563);
in_attr11.w = float(0.00);
in_attr12.x = float(0.13904);
in_attr12.y = float(0.39209);
in_attr12.z = float(1.01953);
in_attr12.w = float(0.00);
fs_cbuf8[29] = uvec4(1136202434, 1156667142, 3308015118, 0);
...
fs_cbuf15[1] = uvec4(0, 1065353216, 1067452920, 1065353216);
...
fs_cbuf15[28] = uvec4(3179373586, 3207334849, 3208437907, 0);
...
fs_cbuf15[57] = uvec4(1169633610, 1157635914, 1161527296, 1065353216);
  bool b_0 = bool(0);
  bool b_1 = bool(0);
  uint u_0 = uint(0);
  uint u_1 = uint(0);
