...
void main(){
gl_FragCoord = vec4(93.254776, 2347.8066, 2.88073, 4.96142);
in_attr0.x = float(1.00);
in_attr0.y = float(1.00);
in_attr0.z = float(1.00);
in_attr0.w = float(0.85);
in_attr1.x = float(2.34642);
in_attr1.y = float(-6.22637);
in_attr1.z = float(0.00);
in_attr1.w = float(4.96142);
in_attr2.x = float(0.125);
